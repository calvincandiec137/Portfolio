  ...
  return (
    <section id="home" className="min-h-screen flex items-center border-b border-border pt-16">
      <div className="max-w-7xl mx-auto px-5 text-2xl py-20">
        ...
        <div className="bg-card border border-border p-5 rounded text-sm text-card-foreground max-w-5xl">
          <div>
            <span className="text-accent mr-2 select-none">$</span>
            neofetch
          </div>
          <pre className="text-muted-foreground mt-2 mb-4 whitespace-pre-wrap text-2xl">
            {`OS: ${terminal.os}
